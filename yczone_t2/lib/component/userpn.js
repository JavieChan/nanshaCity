                        ...
                        return (
                            <tbody key={index}>
                                <tr className={ ((list.mask&(1<<30))==0) ? null : "dab" }>
                                    ...
                                    <td>
                                        { ((list.mask&(1<<25))>0 && (location=='50001,59920,15914')) ? <span className="sta checkup">已审核</span> : null }
                                        { ((list.mask&(1<<21))>0 && (location=='50001,59920,15914')) ? <span className="sta hasreject">已驳回</span> : null }
                                        { ((list.mask&(1<<20))>0 && (location=='50001,59920,15914')) ? <span className="sta wait">待审核</span> : null }
                                        { this.state.view ? <a href={"/projectuserpninfo.html?location="+location+"&mask=1&user_id="+list.id}>详情</a> : null }
                                        ...
                                        { this.state.update&&(location=='50001,59920,15914') ? <span className="reject" data-mobile={list.mobile}>驳回</span> : null }
