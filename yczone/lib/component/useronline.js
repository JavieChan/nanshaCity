            ...
            <table className="tbodyClass">
                <thead>
                {
                    <SortCmp callbackSort={this.props.callbackSort} update={this.state.update} sortIndex={this.props.sortIndex} xbcheck={this.props.xbcheck}>
                        ...
                        <span name="auth_type"><em>认证方式</em><i></i></span>
                        <i>操作</i>
                    </SortCmp>
                }
                        ...
                        return (
                            <tbody key={index}>
                                <tr className={mask ? null : "dab"}>
                                    ...
                                    <td>
                                        { this.state.view ? <a href={"/projectuseraccountinfo.html?user_id="+list.user+"&mac="+list.mac+"&ip="+list.ip+"&location="+location}>详情</a> : null }
                                        { !!list.user && this.state.update ? (forbin) : null}
...
ReactDOM.render(
    <Box />,
    document.querySelector('#userOnlineMemTable')
);