    ...
    function assignData(chartData, idx){
        ...
        if(idx==0){
            ...
            var aa=chartData.ap_online_status.online_count,
                ...
                pc=chartData.device_status.pc_count,
                android=chartData.device_status.android_count,
                ios=chartData.device_status.ios_count,
            ...
            var ho=pc+android+ios+wx;
            onlinePieC.push(['安卓', parseInt(android/ho*100)], ['IOS', 100-(parseInt(android/ho*100)+parseInt(wx/ho*100)+parseInt(pc/ho*100))], ['微信', parseInt(wx/ho*100)], ['PC', parseInt(pc/ho*100)]);
            onlineLineA.push({
                name: '在线',
                color: colorStep[0][0],
            ...
            onlineLineC.push({
                name: '安卓',
                color: colorStep[2][0],
                data: chartData.device_chart_data.android
            },{
                name: 'IOS',
                color: colorStep[2][1],
                data: chartData.device_chart_data.ios
            },{
                name: '微信',
                color: colorStep[2][2],
            ...
            },
            {
                name: 'PC',
                color: colorStep[2][3],
                data: chartData.device_chart_data.pc
            });
            area24.push({
                name: '用户流量',
                color: '#276089',
